...
<template>
  ...
  >
    ...
    <div
      v-if="!hasFile"
      @click="emit('click')"
      :class="['group absolute inset-4 flex flex-col items-center justify-center cursor-pointer transition-colors rounded-xl border-2 border-dashed bg-white/50 dark:bg-neutral-900/50', isDragging ? 'border-blue-500/60 bg-blue-500/5' : 'border-neutral-300 dark:border-neutral-700 hover:border-blue-400/50 dark:hover:border-blue-500/40 hover:bg-neutral-100/60 dark:hover:bg-neutral-800/40']"
    >
      <EditorEmptyState
        icon="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"
        title="Arrastra una imagen aquí"
        accent="#3b82f6"
        :chips="['Filtros', 'Recorte', 'Ajustes', 'Texto', 'Formas']"
        formats="JPG, PNG, GIF, WebP, BMP — todo se procesa en tu navegador"
      />
    </div>
