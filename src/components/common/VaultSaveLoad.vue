...
function togglePanel() {
  ...
  if (showPanel.value) refreshList()
}
...
<template>
  <div class="relative inline-flex items-center gap-1">
    ...
    <!-- Save input popover -->
    <div v-if="showSaveInput" class="absolute top-full left-0 mt-1 z-50 bg-neutral-800 border border-neutral-700 rounded-lg p-3 shadow-xl min-w-[220px]">
    ...
    <!-- Items list panel -->
    <div v-if="showPanel" class="absolute top-full left-0 mt-1 z-50 bg-neutral-800 border border-neutral-700 rounded-lg shadow-xl min-w-[260px] max-h-[300px] overflow-hidden flex flex-col">
