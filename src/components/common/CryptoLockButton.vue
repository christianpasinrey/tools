...
<template>
  <div class="relative inline-flex items-center">
    ...
    <div v-if="showUnlockInput" class="absolute top-full right-0 mt-1 z-50 bg-neutral-800 border border-neutral-700 rounded-lg p-3 shadow-xl min-w-[240px]">
    ...
    <!-- Setup Flow Modal -->
    <div v-if="showSetupFlow" class="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
    ...
    <!-- Reset Confirm Modal -->
    <div v-if="showResetConfirm" class="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
