  ...
  <div class="flex flex-col h-full">
    ...
    <div class="flex border-b border-neutral-200 dark:border-neutral-800">
      <button
        ...
        :class="activeConfigTab === tab.id ? 'text-neutral-900 dark:text-white' : 'text-neutral-500 hover:text-neutral-700 dark:hover:text-neutral-300'"
      >
        {{ tab.name }}
      ...
      <div v-if="activeConfigTab === 'params'">
        <div v-for="(param, idx) in params" :key="idx" class="flex items-center gap-2 mb-2">
          ...
          <input
            v-model="param.key"
            placeholder="Key"
            class="flex-1 bg-neutral-100 dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 rounded px-2.5 py-1.5 text-sm text-neutral-900 placeholder-neutral-400 dark:text-white dark:placeholder-neutral-600 outline-none focus:border-amber-500/50"
          />
          <input
            v-model="param.value"
            placeholder="Value"
      ...
      <div v-if="activeConfigTab === 'body'">
        <div class="flex gap-2 mb-3">
          <button
            ...
            :class="bodyType === type ? 'bg-amber-500/20 text-amber-400 border border-amber-500/30' : 'bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400 border border-neutral-300 dark:border-neutral-700 hover:border-neutral-300 dark:border-neutral-600'"
          >
            {{ type }}
          </button>
        </div>
        <div v-if="bodyType !== 'none'">
          <textarea
            ...
            class="w-full h-48 bg-neutral-100 dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 rounded p-3 text-sm text-neutral-900 font-mono placeholder-neutral-400 dark:text-white dark:placeholder-neutral-600 outline-none focus:border-amber-500/50 resize-none"
          />
        </div>
      ...
      <div v-if="activeConfigTab === 'auth'">
        <div class="flex gap-2 mb-4">
          <button
            ...
            class="px-3 py-1 text-xs rounded transition-colors capitalize"
            :class="authType === type ? 'bg-amber-500/20 text-amber-400 border border-amber-500/30' : 'bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400 border border-neutral-300 dark:border-neutral-700 hover:border-neutral-300 dark:border-neutral-600'"
          >
        ...
        <div v-if="authType === 'bearer'" class="space-y-2">
          <label class="text-xs text-neutral-600 dark:text-neutral-400">Token</label>
          <input
            :value="authConfig.bearer.token"
            @input="updateAuthField('bearer', 'token', $event.target.value)"
            placeholder="Enter token..."
            class="w-full bg-neutral-100 dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 rounded px-3 py-2 text-sm text-neutral-900 placeholder-neutral-400 dark:text-white dark:placeholder-neutral-600 outline-none focus:border-amber-500/50"
          />
        </div>
        ...
        <div v-if="authType === 'basic'" class="space-y-3">
          <div>
            <label class="text-xs text-neutral-600 dark:text-neutral-400">Username</label>
            <input
              :value="authConfig.basic.username"
              @input="updateAuthField('basic', 'username', $event.target.value)"
              placeholder="Username"
              class="w-full bg-neutral-100 dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 rounded px-3 py-2 text-sm text-neutral-900 placeholder-neutral-400 dark:text-white dark:placeholder-neutral-600 outline-none focus:border-amber-500/50 mt-1"
            />
          </div>
          <div>
            <label class="text-xs text-neutral-600 dark:text-neutral-400">Password</label>
            <input
        ...
        <div v-if="authType === 'apikey'" class="space-y-3">
          <div>
            <label class="text-xs text-neutral-600 dark:text-neutral-400">Key</label>
            <input
          ...
          <div>
            <label class="text-xs text-neutral-600 dark:text-neutral-400">Value</label>
            <input
          ...
          <div>
            <label class="text-xs text-neutral-600 dark:text-neutral-400">Add to</label>
            <div class="flex gap-2 mt-1">
              <button
                @click="updateAuthField('apikey', 'addTo', 'header')"
                class="px-3 py-1 text-xs rounded"
                :class="authConfig.apikey.addTo === 'header' ? 'bg-amber-500/20 text-amber-400 border border-amber-500/30' : 'bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400 border border-neutral-300 dark:border-neutral-700'"
              >
                Header
              </button>
              <button
                ...
                class="px-3 py-1 text-xs rounded"
                :class="authConfig.apikey.addTo === 'query' ? 'bg-amber-500/20 text-amber-400 border border-amber-500/30' : 'bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400 border border-neutral-300 dark:border-neutral-700'"
              >
                Query Param
              </button>
            </div>
