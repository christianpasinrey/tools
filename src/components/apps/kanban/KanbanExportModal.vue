...
<template>
  <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50" @click.self="emit('close')">
    <div class="w-96 bg-white border border-neutral-200 dark:bg-neutral-900 dark:border-neutral-700 rounded-xl shadow-2xl overflow-hidden">
      <!-- Header -->
      ...
      <div class="p-4 space-y-4">
        <!-- Export section -->
        <div>
          <h4 class="text-xs font-medium text-neutral-700 dark:text-neutral-300 mb-2">Exportar</h4>
          <div class="space-y-1.5">
            <label class="flex items-center gap-2 cursor-pointer">
              ...
              <span class="text-xs text-neutral-700 dark:text-neutral-300">JSON</span>
            ...
            <label class="flex items-center gap-2 cursor-pointer">
              ...
              <span class="text-xs text-neutral-700 dark:text-neutral-300">CSV</span>
            ...
            <label class="flex items-center gap-2 cursor-pointer">
              ...
              <span class="text-xs text-neutral-700 dark:text-neutral-300">Markdown</span>
          ...
          <button
            @click="doExport"
            :disabled="!board"
            class="mt-3 w-full px-3 py-2 text-xs bg-indigo-500 hover:bg-indigo-400 disabled:bg-neutral-300 dark:disabled:bg-neutral-700 text-white rounded-lg font-medium transition-colors flex items-center justify-center gap-1.5"
          >
        ...
        <div class="border-t border-neutral-200 dark:border-neutral-800 pt-4">
          <h4 class="text-xs font-medium text-neutral-700 dark:text-neutral-300 mb-2">Importar</h4>
          <label class="flex items-center justify-center gap-1.5 px-3 py-2 text-xs bg-neutral-800 hover:bg-neutral-700 text-neutral-700 dark:text-neutral-300 border border-neutral-600 rounded-lg cursor-pointer transition-colors">
            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
