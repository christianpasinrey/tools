    ...
    <div class="max-w-6xl mx-auto">
      ...
      <div class="grid lg:grid-cols-[1fr,400px] gap-8">
        ...
        <div class="space-y-6">
          ...
          <!-- Framework Selector -->
          <div class="bg-neutral-900 rounded-xl border border-neutral-800 p-4">
            <h3 class="text-sm font-semibold text-neutral-400 uppercase tracking-wider mb-4">Framework de destino</h3>
          ...
          <div class="bg-neutral-900 rounded-xl border border-neutral-800 p-4">
            ...
            <pre class="p-3 bg-neutral-800 rounded-lg text-xs text-neutral-300 font-mono overflow-x-auto max-h-64"><code>{{ tester.generatedCode.value }}</code></pre>
          </div>
          ...
          <div class="p-4 bg-neutral-900/50 rounded-xl border border-neutral-800">
            <div class="flex items-center gap-2 mb-2">
              ...
              <span class="text-white font-medium">Componente SIP WebRTC</span>
            </div>
            <p class="text-neutral-500 text-sm">
              El componente Phone utiliza JsSIP para establecer conexiones WebRTC sobre SIP.
              Asegurate de tener un servidor SIP compatible con WebSocket.
            </p>
          </div>
        </div>
        ...
        <div class="space-y-6">
          <!-- Phone Preview -->
          <div
            class="rounded-xl flex items-center justify-center p-6 min-h-[400px]"
          ...
          >
            ...
            <div v-else class="text-center">
              <div class="w-20 h-20 mx-auto mb-4 rounded-full bg-neutral-800 flex items-center justify-center">
              ...
              <p class="text-neutral-500 text-sm">Completa la configuracion</p>
              <p class="text-neutral-600 text-xs mt-1">El preview aparecera aqui</p>
            </div>
          </div>
          ...
          <div class="bg-neutral-900 rounded-xl border border-neutral-800 p-4">
            ...
            <div class="space-y-1.5 max-h-48 overflow-y-auto">
              ...
              <div v-if="callLogs.length === 0" class="text-center py-6 text-neutral-600 text-xs">
          ...
          <!-- Quick Guide -->
          <div class="bg-neutral-900 rounded-xl border border-neutral-800 p-4">
            <h3 class="text-sm font-semibold text-neutral-400 uppercase tracking-wider mb-3">Guia rapida</h3>
            <div class="space-y-2">
              <div class="flex gap-2 text-xs">
                <span class="flex items-center justify-center w-5 h-5 rounded-full bg-emerald-500/20 text-emerald-400 font-bold shrink-0">1</span>
                <p class="text-neutral-400">Configura los datos de conexion SIP</p>
              </div>
              <div class="flex gap-2 text-xs">
                <span class="flex items-center justify-center w-5 h-5 rounded-full bg-emerald-500/20 text-emerald-400 font-bold shrink-0">2</span>
                <p class="text-neutral-400">Prueba el componente en el preview</p>
              </div>
              <div class="flex gap-2 text-xs">
                <span class="flex items-center justify-center w-5 h-5 rounded-full bg-emerald-500/20 text-emerald-400 font-bold shrink-0">3</span>
                <p class="text-neutral-400">Selecciona el framework y copia el codigo</p>
              </div>
            </div>
          </div>
        </div>
