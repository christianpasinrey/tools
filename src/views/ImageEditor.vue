...
<template>
  <div class="h-screen flex flex-col bg-neutral-950 text-neutral-300 select-none">
    ...
    <ImageToolbar
      ...
      :is-painting="editor.isPainting.value"
      ...
      @paint="editor.startPaintMode"
      @stop-paint="editor.stopPaintMode"
      @brush-color="editor.setBrushColor"
      @brush-size="editor.setBrushSize"
      @eyedropper="editor.startEyedropper"
    ...
    <div class="flex-1 flex overflow-hidden">
      ...
      <ImageCanvas
        ...
        :is-painting="editor.isPainting.value"
        :is-eyedropping="editor.isEyedropping.value"
        :eyedropper-preview="editor.eyedropperPreview.value"
        @canvas-ready="onCanvasReady"
        @drop="handleDrop"
        @dragover="isDragging = true"
        @dragleave="isDragging = false"
        @click="openFilePicker"
        @draw-start="(x, y) => editor.startDrawing(x, y)"
        @draw-move="(x, y) => editor.draw(x, y)"
        @draw-end="editor.stopDrawing"
        @eyedropper-move="(x, y, sx, sy) => editor.updateEyedropperPreview(x, y, sx, sy)"
        @eyedropper-pick="(x, y) => editor.pickColor(x, y)"
